...
const ProductItem = ({ item }) => {
    return (
        <div className='flex flex-col bg-white rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 ease-in-out overflow-hidden w-[300px]  lg:w-[340px] 2xl:w-[350px] mx-auto hover:scale-105'>
            {/* Image Container */}
